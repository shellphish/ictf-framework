...
ARGS="$OUT_DIR/${BUILDER}_teamvm_base.json"
ARGS="$ARGS -t"
...
ARGS="$ARGS $SCRIPT_DIR/components/provisioners/teamvm_base.json"
ARGS="$ARGS -o variables->IMAGE_NAME=teamvm -o variables->BUILD_STAGE=base"
ARGS="$ARGS $@"
